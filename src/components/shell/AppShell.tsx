...
import { useFleetData, useRealtimeSync, useGroundedStatus, useAircraftRole, usePullToRefresh, useResumeFromBackground, useHowardSessionLifecycle, useTabHistory, useAircraftRevalidator } from "@/hooks";
...
const OnboardingRouter = dynamic(() => import("@/components/shell/OnboardingRouter"), { ssr: false });
  ...
  return (
    <div className="flex flex-col bg-neutral-100 w-full min-h-screen relative">
      ...
      <AppHeader
        ...
        showFleetButton={showFleetButton}
        role={role}
        showTailDropdown={showTailDropdown}
        setShowTailDropdown={setShowTailDropdown}
        onNavigateTab={navigateTab}
        onTailChange={handleTailChange}
        onOpenLogIt={() => setShowLogItModal(true)}
