...
const STEPS: Step[] = [
  {
    ...
    lead: "Quick tour — eight stops, under a minute. I'll point out where everything lives so you know what the app can do for you.",
    bullets: [],
  },
  {
    target: 'summary',
  ...
  },
  {
    ...
    hero: FolderOpen,
    eyebrow: "Step 5 of 8",
    title: "Documents & Equipment — the paperwork",
    lead: "Upload once, search anywhere. Equipment drives your airworthiness verdict.",
    bullets: [
      { icon: FolderOpen, text: "POH, registration, airworthiness cert, W&B, MEL — searchable" },
      { icon: Wrench, text: "Equipment list with 91.411/91.413/91.207 due dates" },
      { icon: MessageSquare, text: "Howard can search inside your docs in a chat" },
    ],
  },
  {
    target: '',
    ...
    hero: MessageSquare,
    eyebrow: "Step 6 of 8",
    title: "Notes — the crew message board",
    lead: "Short-form updates that stay with the aircraft, not a group text that scrolls away.",
    bullets: [
      { icon: MessageSquare, text: "Post a note with optional photos" },
      { icon: PenLine, text: "The next pilot sees it before they fly" },
      { icon: Home, text: "Unread count badged on the nav" },
    ],
  },
  {
    target: 'howard-fab',
