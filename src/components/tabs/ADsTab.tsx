            ...
            <div className="bg-white rounded shadow-2xl w-full max-w-md p-5 border-t-4 border-[#7C3AED] animate-slide-up">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div><label className="text-[10px] font-bold uppercase tracking-widest text-navy block">At Aircraft Hours</label><input type="number" step="0.1" value={fLastCompliedTime} onChange={e => setFLastCompliedTime(e.target.value)} style={INPUT_WHITE_BG} className="w-full border border-gray-300 rounded p-3 text-sm mt-1 focus:border-[#7C3AED] outline-none" /></div>
                </div>
                ...
                {fComplianceType === 'recurring' && (
                  <div className="grid grid-cols-2 gap-3 bg-gray-50 p-3 rounded border border-gray-200">
                    <div><label className="text-[10px] font-bold uppercase tracking-widest text-navy block">Every (hrs)</label><input type="number" step="0.1" value={fRecurringHours} onChange={e => setFRecurringHours(e.target.value)} style={INPUT_WHITE_BG} className="w-full border border-gray-300 rounded p-3 text-sm mt-1 focus:border-[#7C3AED] outline-none" /></div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div><label className="text-[10px] font-bold uppercase tracking-widest text-navy block">Next Due Hours</label><input type="number" step="0.1" value={fNextDueTime} onChange={e => setFNextDueTime(e.target.value)} style={INPUT_WHITE_BG} className="w-full border border-gray-300 rounded p-3 text-sm mt-1 focus:border-[#7C3AED] outline-none" /></div>
                </div>
