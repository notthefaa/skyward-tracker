...
export default function SummaryTab({ 
  aircraft, setActiveTab, role, onDeleteAircraft, sysSettings
}: { 
    ...
    <div className="flex flex-col gap-4 animate-fade-in relative">
      ...
      <div className="bg-white shadow-lg rounded-sm overflow-hidden">
        <div className="relative h-40 md:h-56 bg-slateGray flex items-center justify-center">
          ...
          {role === 'admin' && (
            <button onClick={() => setShowDeleteModal(true)} className="absolute top-4 right-4 bg-[#CE3732] text-white p-2.5 rounded-full shadow-[0_4px_10px_rgba(0,0,0,0.5)] hover:bg-red-700 active:scale-95 transition-all z-10" title="Delete Aircraft"><Trash2 size={18} /></button>
          )}
